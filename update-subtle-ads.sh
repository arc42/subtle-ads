...
git push https://github.com/arc42/$faqsite.git
cd ..
...
git add .
git commit -m "updated subtle-ads $(date +%Y-%m-%d)"
git push https://github.com/arc42/docs.arc42.org-site.git
cd ..
...
#git add .
#git commit -m "updated subtle-ads $(date +%Y-%m-%d)"
#git push https://github.com/arc42/patterns.arc42.org-site.git
#cd ..
...
#git add .
#git commit -m "updated subtle-ads $(date +%Y-%m-%d)"
#git push https://github.com/arc42/arc42.org-site.git
#cd ..
